...
<h1 style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; color: #3d4852; font-size: 18px; font-weight: bold; margin-top: 0; text-align: left;">Uspešna Kupovina!</h1>
<p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">Uspešna kupovina karata za film {{$data['Projekcija']}}  .</p>
...
<table>
  ...
  <tbody>
      <tr>
          <td>{{ $data['Broj Racuna'] }}</td>
          <td>{{ $data['Projekcija'] }}</td>
          <td>{{ $data['Datum'] }}</td>
          <td>{{ $data['Vreme'] }}</td>
          <td>{{ $data['Sala'] }}</td>
          <td>{{ $data['Red'] }}</td>
          <td>{{ $data['Sedista'] }}</td>          
          <td>{{ $data['Ukupna Cena'] }} RSD</td>
      </tr>
  </tbody>
</table>
