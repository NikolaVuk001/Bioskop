    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item nav_item"><a href="{{url('/Film/All/U-Ponudi')}}" class="nav-link">Filmovi</a></li>
                ...
                <li class="nav-item nav_item searchBar d-md-block d-sm-none hidden-mobile">
                    <form class="d-flex" role="search">
                        <input class="form-control me-3" type="search" placeholder="Search"
                            aria-label="Search" style="padding-left: 0.5rem">
                        <button type="submit" class="btn btn-default " style="">
                            <i class="fa-solid fa-magnifying-glass" style="padding-right: 0.5rem; padding-left: 0px; margin-left: 0px"></i>
                        </button>
                    </form>
                </li>
                ...
                <li class="nav-item nav_item" style="margin-right: 12px;">
                    <a class="nav-link" href="{{url('/Repertoar')}}" style="display:flex;" >
                        <img src="{{ asset('assets/icons/ticket-perforated.svg') }}" class="ulaznice" width="30" height="30"
                            alt="Tickets"
