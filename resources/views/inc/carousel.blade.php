                    ...
                    <div class="container">
                        <div class="row justify-content-start text-left">
                            <div class="col-12 d-md-block d-sm-none hidden-mobile py-3 mx-0">
                                ...
                                <p>
                                    <a href="{{url('/Repertoar/Film/' . $filmSlide1->id)}}" class="btn btn-danger btn-lg">Kupi Karte</a>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container">
                        <div class="row justify-content-start text-left">
                            <div class="col-12 d-md-block d-sm-none hidden-mobile py-3 mx-0">
                                ...
                                <p>
                                    <a href="{{url('/Repertoar/Film/' . $filmSlide2->id)}}" class="btn btn-danger btn-lg">Kupi Karte</a>
                                </p>
                            </div>
                        </div>
                    </div>
